...
- Kalite kapısını geçen toplam örnek: **515**
- Tekil şablon ailesi: **515**
...
- Gerçek/resmî kaynaklı örnek oranı: **%88.0**
- Sentetik örnek oranı: **%12.0**
...
| `separate_dev_heldout_records` | 0 | 119 |
