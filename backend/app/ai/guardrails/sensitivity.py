...
class SensitivityAssessment(BaseModel):
    ...
    level: SensitivityLevel = Field(description="Belgeden çıkarılan gizlilik derecesi.")
    pii_findings: list[PiiFinding] = Field(default_factory=list)
    requires_review: bool = Field(
        description="Gizlilik derecesi politika eşiğini aşıyorsa True."
    )
...
def assess(
    *,
    ...
    requires_review = level in active_policy.sensitivity_block_levels
