...
- **Süreç Üst-Yorumu Yasağı**: Gövde metninde kendi analiz/inceleme sürecine dair soyut üst-yorum yapma. "Sadece verilen kayıt incelenmiştir", "yalnızca sağlanan bilgiler doğrultusunda değerlendirilmiştir" gibi kaynağa/sürece atıf yapan, hiçbir somut olguyu isimlendirmeyen dolgu ifadeleri KESİNLİKLE YASAKTIR. Bunun yerine her zaman somut konuya bağlı bir ifade kullan (örn. "incelenmiştir" yazacaksan neyin incelendiğini adıyla belirt: "[X talebiniz], [Y mevzuatı] kapsamında incelenmiştir").
