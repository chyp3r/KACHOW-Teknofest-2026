...
Altın küme: `evaluation/datasets/intents.jsonl` · Koşu: 2026-08-22T22:21:12 · Süre: 103.8 ms
...
Altın küme: `evaluation/datasets/drafts.jsonl` · Koşu: 2026-08-22T22:21:12 · Süre: 7.5 ms
...
Altın küme: `evaluation/datasets/evrak.jsonl` · Koşu: 2026-08-22T22:21:12 · Süre: 64.7 ms
...
| 4 -- eksik bilgi tespiti | **Yanlış alarm oranı** | **0.2775** |
| 4 -- eksik bilgi tespiti | Kaçırma oranı | 0.0000 |
| 5 -- mevzuat atfı doğrulaması | Doğruluk | 1.0000 |

Vaka sayısı: 35 · Eksik-alan (alan, belge) çifti: TP=21 FP=58 TN=151 FN=0 · Çıkarım: doğru=53 kaçan=8 yanlış=9 sahte=0 · Atıf: TP=1 FP=0 TN=2 FN=0

### Kategori kırılımı

| Kategori | Vaka | OCR yönlendirme doğruluğu | Eksik-alan yanlış alarm oranı |
|---|---|---|---|
| `gercek_tarama` | 23 | 1.00 | 0.34 |
| `sentetik` | 12 | 1.00 | 0.11 |

### Eksik-alan kümesi uyuşmayan belgeler (28)
...
| `CY-001` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-003` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-005` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-009` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani']` |
| `CY-010` | `gercek_tarama` | `['konu']` | `['gonderen_kurum', 'konu', 'muhatap']` |
| `CY-012` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani']` |
| `CY-014` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-017` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-019` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-021` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani']` |
| `CY-024` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-030` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-036` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-006` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani']` |
| `CY-023` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-028` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
...
| `CY-039` | `gercek_tarama` | `['tarih']` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
| `CY-049` | `gercek_tarama` | `[]` | `['imza_sahibi', 'imza_unvani', 'tarih']` |
