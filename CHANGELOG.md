...
### Test
- Yön farkındalıklı yazışma-türü/alt-tür çözümlemesi (orkestratör boilerplate'inin hiçbir türe eşleşmediği regresyon kilidi dahil), bireysel dilekçe için yapısal denetim istisnası, yazım briefi "Yazışma türü" yuvası ve `emit_reply_stream`/akış-yalnız-nihai-yanıt davranışı için kapsamlı birim ve entegrasyon testleri eklendi.
